...
if not os.path.exists(f'/home/chetos/projetos-git/backup-scripts/{date.today()}'):
    os.makedirs(f'/home/chetos/projetos-git/backup-scripts/{date.today()}')
...
for ip in lines:
    ...
    backupFile = open(f"/home/chetos/projetos-git/backup-scripts/{date.today()}/{ip}.cfg", "w+")
